...
namespace Test
{
    ...
    public class TestScanner
    {
        ...
        public static TestResult[] ScanResult1 = new[]{
            ...
            new TestResult(true, new MovieInfos("Ratatouille", null, @"\!A ne pas manquer ;o)\Ratatouille.FRENCH.DVDRip.XviD.avi", false, true)),
            ...
            new TestResult(true, new MovieInfos("How to Train Your Dragon", null, @"\How to Train Your Dragon 2010 1080p BRRip H264 AAC - IceBane (Kingdom Release)\Xbox 360 2 Ch Audio\How to Train Your Dragon 2 Ch Audio.mp4", false, true)),
            ...
            new TestResult(true, new MovieInfos("Babel", null, @"\Babel.FRENCH.DVDRiP.XviD-BABEL.CD2.avi", true, true)),                                                                 
        };
        ...
        public static TestResult[] ScanResult2 = new[]{
            ...
            new TestResult(true, new MovieInfos("Gegen Die Wand", 2004, @"\Gegen die Wand\Gegen.Die.Wand.CD2.2004.DVDRip.XviD.AC3-TURKiSO.avi", true, true)),
            ...
            new TestResult(true, new MovieInfos("L Affaire Farewell", null, @"\L.Affaire.Farewell.FRENCH.BDRip.XviD-Carion\L.Affaire.Farewell.FRENCH.BDRip.XviD-Carion.cd2.avi", true, true)),
            ...
            new TestResult(true, new MovieInfos("Le Ruban Blanc", null, @"\Le.Ruban.Blanc FRENCH.DVDRip.XviD-UNSKiLLED\Le.Ruban.Blanc.CD2.FRENCH.DVDRip.XviD-UNSKiLLED.avi", true, true)),
            ...
            new TestResult(true, new MovieInfos("Los Abrazos Rotos", 2009, @"\Los Abrazos Rotos[2009]Espanol[DvDrip]Omifast Greek\Los Abrazos Rotos (2009) CD2.divx", true, true)),
            ...
            new TestResult(true, new MovieInfos("Love in the Time of Cholera", null, @"\Love.in.the.Time.of.Cholera.DVDRip.XviD-DiAMOND\dmd-lovecholera-cd2.avi", true, true)),
            ...
            new TestResult(true, new MovieInfos("Rapt", null, @"\Rapt.FRENCH.BDRip.XviD-Belvaux\belvaux_rapt_xvid-cd2.avi", true, true)),
            ...
            new TestResult(true, new MovieInfos("Seven Pounds", null, @"\Seven.Pounds.DVDRip.XViD-PUKKA\p-7p-cd2.avi", true, true)),
            ...
            new TestResult(true, new MovieInfos("The Hangover", null, @"\The.Hangover.UNRATED.720p.BluRay.x264-REFiNED\refined-the.hangover-720p.mkv", false, true)),
